...
hold on
scatter(srmsfAlpha, sdfaGamma, 1, 'y','filled') ;
hold on
...
% Ellipse_plot(ax2D, ellipsoid_equation, ellipsoid_center, 1000);
hold on
scatter(srmsfAlpha, smsdBeta, 1, 'y','filled')
hold on
% xlabel('Shuffled RMSF Alpha')
...
% Ellipse_plot(ax2D, ellipsoid_equation, ellipsoid_center, 1000);
hold on
scatter(sdfaGamma, smsdBeta, 1, 'y','filled')
hold on
...
% Ellipse_plot(ax2D, ellipsoid_equation, ellipsoid_center, 1000);
hold on
scatter(smsdBeta, sApEn, 1, 'y','filled')
hold on
...
% Ellipse_plot(ax2D, ellipsoid_equation, ellipsoid_center, 1000);
hold on
scatter(srmsfAlpha, sApEn, 1, 'y','filled')
hold on
% xlabel('Shuffled RMSF Alpha')
% ylabel('Shuffled ApEn')
% set(gca, 'Color','k', 'XColor','w', 'YColor','w')
...
% Ellipse_plot(ax2D, ellipsoid_equation, ellipsoid_center, 1000);
hold on
scatter(sdfaGamma, sApEn, 1, 'y','filled')
hold on
% xlabel('Shuffled DFA Gamma')
% ylabel('Shuffled ApEn')
% set(gca, 'Color','k', 'XColor','w', 'YColor','w')
